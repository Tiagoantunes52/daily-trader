...
class UserService:
    ...
    def get_user_by_id(self, user_id: str) -> UserProfile:
        ...
        return self.db_session.query(UserProfile).filter(UserProfile.id == user_id).first()
    ...
    def update_email(self, user_id: str, new_email: str) -> UserProfile:
        ...
        existing_user = (
            self.db_session.query(UserProfile)
            .filter(UserProfile.email == new_email, UserProfile.id != user_id)
            .first()
        )
    ...
    def update_delivery_times(
        self, user_id: str, morning_time: str | None = None, evening_time: str | None = None
    ) -> UserProfile:
        """
    ...
    def update_asset_preferences(self, user_id: str, asset_preferences: list[str]) -> UserProfile:
        """
